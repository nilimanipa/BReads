...
<html lang="en">
    ...
    <body>
        ...
        <fieldset style="width: 40%; height: auto;">
            <legend><b>Customer Profile</b></legend>
            <br>
            <form action="/ProjectDH/Controller/EditcustomerAction.php" method="POST" onsubmit="return validcustomer(this)">
                <?php 
                ...
                <input type="number" name="book id" value="<?php echo $id; ?>" hidden>
                <table>
                    <tr>
                        <td>
