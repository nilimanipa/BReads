...
<html lang="en">
    ...
    <body>
        <?php 
            $bookname = $authorname = $dob = $phone = $email = $username = $password = $conpassword = "";
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if($isValid and $isChecked){
                    insert_customer($bookname, $authorname, $dob, $phone, $email, $username, $password);
                }

                else if ($isEmpty) {
                    setcookie('msg', '<b>❗Required input missing</b><br>', time() + 1, '/');
                    header("location: /ProjectDH/View/Addbook.php");
                }
