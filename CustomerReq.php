<?php
    ...
    define("t", "../Model/tempCustomer.json");
    $handle_t = fopen(t, "r");
...
<style >
    ...
    <body>
        ...
        <fieldset style="width: 50%; height: 20em; overflow: scroll;">
            <legend><b>Customer Requests</b></legend>
            <br>
                ...
                <?php 
                    if ($arr1 === NULL) {}
                        ...
                        for ($i = 0; $i < count($arr1); $i++) {
                            ...
                            echo "<td>" . "<a href='/ProjectDH/View/AcceptCustomer.php?sl=" . $arr1[$i]->sl . "'>✅Accept</a></td>";
                            echo "<td>" . "<a href='/ProjectDH/View/DeclineCustomer.php?sl=" . $arr1[$i]->sl . "'>❌Decline</a></td>";
                        }
                    }
                ?>
            </tbody>
